...
public class CasbinConfig {
    ...
    public Enforcer casbinEnforcer() {
        ...
        enforcer.addDef("r", "r", "sub, obj, act");
        enforcer.addDef("p", "p", "sub, obj, act");
        enforcer.addDef("e", "e", "some(where (p.eft == allow))");
        enforcer.addDef("m", "m", "r.sub == p.sub && keyMatch2(r.obj, p.obj) && regexMatch(r.act, p.act)");
